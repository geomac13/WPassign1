...
<head>
  ...
  <style media="screen">
	...
	#UHIcsit {
	  z-index: 1;
	 background:url(/images/highlands.jpg);
    ...
    <div id="container">
      ...
      <div id="content">
        ...
        <section id="UHIcsit">         
            ...
            <div class="box w2 h9" id="left">
                <h2>News</h2>           
            </div>

			<div class="box w8 h3 x2 y6" id="bott">
				<h2>UHI Facebook Wall Posts</h2>				
			</div>

            <div class="box w2 h2 x8">
                <div class="img">
			        <img src="/images/Logo_of_the_University_of_the_Highlands_and_Islands.jpg" alt="UHI Logo">
				</div>
            </div>
		...
		<section id="perthmiddle" >
		    <?php include 'College_Section.php'; ?>
        </section>
		
		<section id="perthbottom" >
		    <?php include 'College_Section.php'; ?>
        </section>

		<section id="inverness" >
            <?php include 'College_Section.php'; ?>			
		</section>
		
		<section id="invernessmiddle" >
            <?php include 'College_Section.php'; ?>			
		</section>
		
		<section id="invernessbottom" >
            <?php include 'College_Section.php'; ?>			
		</section>
		...
		<section id="moraymiddle" >
			<?php include 'College_Section.php'; ?>
		</section>
		
		<section id="moraybottom" >
			<?php include 'College_Section.php'; ?>
		</section>
...
var pth_fb_url = "http://graph.facebook.com/perthcollegeuhi?callback=?"
...
$.getJSON(fb_url, function(data){
    ...
    var zip = data ["location"]["zip"];
     $("#leftbox").append("<h3>"+about+"</h3>");
     $("#leftbox").append("<h3>Where<h3>");
	 $("#leftbox").append(street+"<br>");
     $("#leftbox").append(city+"<br>");
     $("#leftbox").append(zip);
